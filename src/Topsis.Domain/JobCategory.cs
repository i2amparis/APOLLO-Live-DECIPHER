namespace Topsis.Domain
{
    public class JobCategory : EntityWithTitle
    {
        ...
        public static JobCategory[] AllJobCategories()
        {
            ...
            return new[]
            {
                new JobCategory(1, "Academia or research organisation"),
                new JobCategory(2, "Business or industry"),
                new JobCategory(3, "Financial institution"),
                new JobCategory(4, "NGO, platform or network"),
                new JobCategory(5, "Public sector"),
